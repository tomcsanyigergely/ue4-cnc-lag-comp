...
{	
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ADefaultCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ADefaultCharacter::LookUpAtRate);
}

void ADefaultCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void ADefaultCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
